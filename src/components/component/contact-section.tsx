  ...
  return (
    <section className="w-full bg-background py-12 md:py-24 lg:py-32 flex items-center justify-center">
      <div className="text-center max-w-4xl px-4">
        ...
        <Link
          href="/contato"
          className={`inline-flex h-10 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 mt-6 ${isShaking ? "shake" : ""}`}
          prefetch={false}
          onClick={handleClick}
        >
