    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-white">
      <div className="container mx-auto px-4 md:px-6 space-y-12 text-center">
        <div className="space-y-4 max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold tracking-tighter sm:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-AzulEscuro3 to-purple-600">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 max-w-5xl mx-auto"> 
          <div className="space-y-6 bg-white p-8 rounded-4xl shadow-lg w-full py-12"> 
            <div className="space-y-2">
              <h2 className="text-2xl font-bold text-AzulEscuro3">Para Prestadores de Serviços</h2>
          ...
          <div className="space-y-6 bg-white p-8 rounded-4xl shadow-lg w-full py-12" > 
            <div className="space-y-2">
              <h2 className="text-2xl font-bold text-AzulEscuro3">Para Usuários</h2>
              <p className="text-gray-600">
